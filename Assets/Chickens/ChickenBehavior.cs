...
public class ChickenBehavior : MonoBehaviour
{
    ...
    /*TODO
	 *  make finder evaluate the state of grainpiles and see  they need filling, if they do, do we have wheat in our mills? if we do, lets mill, if we dont, lets farm
