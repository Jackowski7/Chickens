...
namespace Pathfinding {
	...
	public abstract class GraphNode {
		...
		/** Start of hierarchical node index bits. \see #HierarchicalNodeIndex */
		const int FlagsHierarchicalIndexOffset = 1;
		/** Mask of hierarchical node index bits. \see #HierarchicalNodeIndex */
		const uint HierarchicalIndexMask = (131072-1) << FlagsHierarchicalIndexOffset;

		/** Start of #IsHierarchicalNodeDirty bits. \see #IsHierarchicalNodeDirty */
		const int HierarchicalDirtyOffset = 18;

		/** Mask of the #IsHierarchicalNodeDirty bit. \see #IsHierarchicalNodeDirty */
		 ...
		 *
		 * Bit 0: #Walkable
		 * Bits 1 through 17: #HierarchicalNodeIndex
		 * Bit 18: #IsHierarchicalNodeDirty
		 * Bits 19 through 23: #Tag
		 * Bits 24 through 31: #GraphIndex
		 *
		 ...
		 * such as the #Walkable property or the #AddConnection method. For example if your manually change the #Pathfinding.MeshNode.connections array you need to call this method.
		 */
	...
	public abstract class MeshNode : GraphNode {
		 ...
		 *
		 * \note If you modify this array or the contents of it you must call #SetConnectivityDirty.
		 */
		...
		/** Checks if \a point is inside the node when seen from above */
