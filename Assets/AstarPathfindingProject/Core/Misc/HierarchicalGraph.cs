...
namespace Pathfinding {
	 ...
	 * The connected component is exposed on nodes as the #Pathfinding.GraphNode.Area property and on this class using the #GetArea method.
	 *
	 ...
	 * \shadowimage{hierarchical/connected_components.png}
	 *
	 ...
	 *
	 * \shadowimage{hierarchical/hierarchical_sample.png}
	 *
	 ...
	 *
	 * \video{hierarchical/hierarchical_graph.mp4}
	 *
	 ...
	 *
	 * \video{hierarchical/areas.mp4}
	 *
	 * \see #Pathfinding.PathUtilities.IsPathPossible
	 * \see #Pathfinding.NNConstraint
	 * \see #Pathfinding.GraphNode.Area
	 */
