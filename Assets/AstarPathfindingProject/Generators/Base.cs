...
namespace Pathfinding {
	...
	public abstract class NavGraph : IGraphInternals {
		 ...
		 *
		 * \see #Pathfinding.AstarData.GetNodes
		 */
	...
	public class GraphCollision {
		 ...
		 *
		 * The returned array may be larger than the actual number of hits, the \a numHits out parameter indicates how many hits there actually were.
		 */
