...
- 4.1.22 (2018-08-27)
	- Upgrade notes
		- When changing some low level fields that can affect the connectivity of the graph such as #Pathfinding.MeshNode.connections you must now call #Pathfinding.GraphNode.SetConnectivityDirty().
			...
			All high level methods that modify the connectivity do this automatically.
...
- 4.1.21 (2018-08-09)
	- An incorrect package was uploaded for 4.1.20 by mistake which had a bunch of compilation errors. This release fixes that.
